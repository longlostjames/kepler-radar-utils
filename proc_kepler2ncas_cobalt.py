...
outpath = os.path.join(amof_proc_path,'cobalt','L1b',datestr)   
...
kepler_utils_old.process_kepler_cobalt_day_step1(datestr,inpath,outpath,yaml_project_file,yaml_instrument_file,azimuth_offset=azimuth_offset,revised_northangle=55.7,gzip_flag=gzip_flag,data_version=data_version);
