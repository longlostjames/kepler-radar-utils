...
# KASBEX Quicklooks Generation - SLURM Array Job
# This script will be updated by submit_kasbex_quicklooks.sh

# Configuration - THESE WILL BE UPDATED BY THE HELPER SCRIPT
START_DATE="20250801"  # YYYYMMDD format
...
cmd_args="-d $target_date --max-age 3"
...
echo "Command: make_kepler_kasbex_quicklooks.py $cmd_args"
echo "============================================================"
...
time python /home/users/cjwalden/git/kepler-radar-utils-cobalt/make_kepler_kasbex_quicklooks.py $cmd_args
