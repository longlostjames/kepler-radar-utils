...
data_date = datetime.datetime.strptime(datestr,"%Y%m%d");

change_date = datetime.datetime.strptime("20230813","%Y%m%d");

#if data_date > change_date:
#    azimuth_offset = 0.74;
#else:
#    azimuth_offset = -7.26;
...
kepler_utils.process_kepler_woest_day_step1(datestr,inpath,outpath,yaml_project_file,yaml_instrument_file,azimuth_offset=azimuth_offset,gzip_flag=True,data_version=data_version);
